...
**ФИКС (следующий шаг, блок 6.1/6.6):** сделать getOpenScreen/getInventoryFull
устойчивыми — внутренний ретрай до стабильного непустого чтения (или читать
рендер-слоты), + меню-клик-кулдаун и ожидание server-ack. Это линчпин надёжного
восприятия для когнитивного агента. Требует ребилда+ретеста на живом лобби.
