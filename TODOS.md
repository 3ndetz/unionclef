...
- [ ] **G-0.3 САМЫЙ КРУПНЫЙ ЭКЗЕМПЛЯР ЭТОГО КЛАССА — `Nav.isPathing()`. ПАТЧ ГОТОВ, НО НЕ ВКЛЮЧЁН.**
...
- [ ] **G-1.37 ЧЕТВЁРТАЯ СТУПЕНЬ: ПЛАВКА. Курс заведён, БЛОКЕР ВОСПРОИЗВОДИТСЯ (2026-08-07).**
