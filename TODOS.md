...
- [ ] **G-1.44 ⭐⭐⭐ ОБЩИЙ КОРЕНЬ ТРЁХ ЗАВИСАНИЙ: `Nav.isPathing()` ГЛУШИТ ВСЕ ПРОГРЕСС-ЧЕКЕРЫ (2026-08-07).**
      ...
      ⛔ ЧТО МЕРИТЬ ПЕРВЫМ ЗАХОДОМ: счётчик «сколько блоков сканер считает недосягаемыми» и
      «сколько кандидатов отброшено этим фильтром» на красном прогоне. Если ствол в этом списке —
      корень найден. Правки до этого замера НЕ ДЕЛАТЬ: четыре подряд уже стоили полдня.
