...
- [ ] **G-1.37 ЧЕТВЁРТАЯ СТУПЕНЬ: ПЛАВКА. Курс заведён, БЛОКЕР ВОСПРОИЗВОДИТСЯ (2026-08-07).**
      ...
      курсор в рюкзак.
      ⛔ СЛЕДУЮЩИЙ ЗАХОД: читать хвост `CraftGenericManuallyTask.onTick` целиком — при каких
      условиях он выполняется, хотя цикл заполнения ещё не закончил свою работу, и почему условие
      `canStackTogether(output, cursor)` пропускает случай «в руке ингредиент, который сейчас
      кладут». Курс воспроизводит за 4 минуты.- [ ] **G-1.36 ДОБЫЧА СЛОМАНА НА САМОМ ПРОСТОМ ИЗ ВОЗМОЖНЫХ СЛУЧАЕВ (2026-08-07).**
