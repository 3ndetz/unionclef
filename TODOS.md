...
- [ ] **G-1.44 ⭐⭐⭐ ОБЩИЙ КОРЕНЬ ТРЁХ ЗАВИСАНИЙ: `Nav.isPathing()` ГЛУШИТ ВСЕ ПРОГРЕСС-ЧЕКЕРЫ (2026-08-07).**
      ...
      ⛔ СЛЕДУЮЩИЙ ЗАХОД (и это, похоже, настоящий #37): чекер должен считать ПРОГРЕСС, а не
      «идёт ли маршрут». Сбрасывать его только когда тело РЕАЛЬНО сместилось, а не когда очередь
      считает себя активной. Гейт — `chop_canopy` (сейчас 2/4) и `craft_at_distant_table` (3/5),
      плюс `wanderTicks` на красных прогонах должен рухнуть.
