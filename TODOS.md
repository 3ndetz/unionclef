...
- [ ] **G-1.4 (2026-08-03) 374 ОТКАЗА «stale-rooted path emission» — ОТКРЫТО, И ОДИН ПУТЬ УЖЕ
      ЗАКРЫТ КАК НЕВЕРНЫЙ.** Пока поиск считает, бот идёт дальше, корень пути устаревает,
      ...
      ВЕРНОЕ НАПРАВЛЕНИЕ: чинить по ту сторону шва — либо ПЕРЕИСКАТЬ от игрока, когда корень
      устарел, либо заставить исполнителя ПЕРЕСИМУЛИРОВАТЬ хвост от фактического состояния
      игрока. Резать массив — нельзя.
