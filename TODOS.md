...
- [ ] **G-0.1 SmartMoves НЕ УМЕЕТ ПЛАВАТЬ — и поэтому не может стать дефолтом (замер 2026-08-06).**
      ...
      ⛔ СЛЕДУЮЩИЙ ЗАХОД: почему не доплывает. Бот теперь входит в воду, вопрос в ИСПОЛНЕНИИ —
      смотреть, где он встаёт (координата), и что делает executor на водяном ребре.
