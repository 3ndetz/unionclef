...
- [ ] **G-1.42 ФЛЕЙК `craft_at_distant_table`: бот УХОДИТ ОТ ЦЕЛИ И ЗАМИРАЕТ (2026-08-07).**
      ...
      ⛔ СЛЕДУЮЩИЙ ЗАХОД: это ВТОРАЯ за день «замер и стой» подпись (первая — нулевой маршрут под
      недосягаемым бревном). Читать, ЧТО именно держит тело неподвижным, когда активна ветка
      блуждания, и почему прогресс-чекер не вытаскивает. Гейт — этот же курс по частоте (нужно
      довести до 5/5), плюс окна заморозки в отчёте.
