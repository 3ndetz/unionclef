...
- [ ] 3. Tungsten block break/place: научить ломать (и в идеале ставить) блоки
  ...
  - [ ] 3.6 Инвентарь и инструменты — сторона ALTOCLEF (мысли юзера, 2026-07-20):
    ...
    - научить брать и ИСПОЛЬЗОВАТЬ инструменты: кирка/лопата/топор под ломаемый блок (сейчас tungsten майнит тем, что в руке; cost уже ваниль-честный через calcBlockBreakingDelta — выбор инструмента должен его улучшать)
