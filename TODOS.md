...
- [ ] **G-1.35 ВТОРАЯ СТУПЕНЬ: СТОРОЖ СЕТКИ СНОВА ЗАЦИКЛИЛСЯ — ТЕПЕРЬ НА КРОВАТИ (2026-08-07).**
      ...
      ⛔ СЛЕДУЮЩИЙ ЗАХОД, УЗКО: прочитать `MoveItemToSlotTask.onTick` вместе с `SlotHandler.clickSlot`
      на этом курсе — какой именно клик уходит (какой слот, какая кнопка) и что происходит со
      стеком после него. Курс воспроизводит за 90 секунд, цикл отладки теперь дешёвый.
