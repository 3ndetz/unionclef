...
- [ ] **G-1.42 ФЛЕЙК `craft_at_distant_table`: бот УХОДИТ ОТ ЦЕЛИ И ЗАМИРАЕТ (2026-08-07).**
      ...
      **КРАФТ ЧЕРЕЗ КНИГУ РЕЦЕПТОВ НА 1.21.11 ОТКЛЮЧЁН ЦЕЛИКОМ.** В `CraftInTableTask` ветка
      ...
      ⚠️ ЭМЕРДЖЕНТНОЕ (записано, в работу ПОСЛЕ текущей цели): ГВАРД `HEALTHY_FPS_MIN = 14`, ПОХОЖЕ,
      ПОДПИСЫВАЕТ ЧУЖИМ ИМЕНЕМ. Замер загрузки: на машине 24 ядра, суммарно занято ~900% (≈600%
