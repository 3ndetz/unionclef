...
- [ ] **C5.15 ПОГОНЯ: СТЕНД МЕРЯЛ НЕ ТО — ТЕПЕРЬ МЕРЯЕТ, И ВИДНО 15 ЗАМИРАНИЙ**
  ...
  флага останова. Бота не ведёт НИКТО. Следующий заход: кто обязан перезапустить погоню, когда
  всё оказалось в простое — читать `FollowEntityTask`/`PunkPlayerTask`, их условие перепланирования.
