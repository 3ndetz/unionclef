...
- [ ] **C5.15 ПОГОНЯ: СТЕНД МЕРЯЛ НЕ ТО — ТЕПЕРЬ МЕРЯЕТ, И ВИДНО 15 ЗАМИРАНИЙ**
  ...
  ЗНАЧИТ лечение НЕ в «тикать всё равно». Варианты для следующего захода (ни один не проверен):
  (а) снимать взведение ТАМ, ГДЕ ОНО СТАВИТСЯ — при остановке ходока, а не внутри тика
  исполнителя; (б) не арминговать вовсе, если ходок не побежал в течение N тиков; (в) отдавать
  взведённый путь обратно планировщику вместо ожидания. Выбирать после чтения `BlockPathWalker`,
  а не наугад.
