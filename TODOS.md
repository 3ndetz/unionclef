...
- [ ] **G-0.1 SmartMoves НЕ УМЕЕТ ПЛАВАТЬ — и поэтому не может стать дефолтом (замер 2026-08-06).**
      ...
      ⛔ СЛЕДУЮЩИЙ ЗАХОД: сравнить, ЧТО именно блок-спейс отдаёт физике на этом курсе с флагом и
      без (первые 5-10 путевых точек), и найти, какое ребро физика не может исполнить.
