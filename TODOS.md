...
- [ ] **G-1.42 ФЛЕЙК `craft_at_distant_table`: бот УХОДИТ ОТ ЦЕЛИ И ЗАМИРАЕТ (2026-08-07).**
      ...
      **`tbl=6018/510@29`**. Дистанция теперь 29 (наш стол в 28), а не 44 — подметание сработало,
      ...
      ⛔ СЛЕДУЮЩАЯ ЦЕЛЬ (та же — курс должен позеленеть): почему крафт в ОТКРЫТОМ верстаке кликает
      пустые слоты. Клики шли по window-слотам 41,42,43,44 (это хотбар 4..7 — `inventorySlotToWindowSlot`
