...
- [ ] **G-1.36 ДОБЫЧА СЛОМАНА НА САМОМ ПРОСТОМ ИЗ ВОЗМОЖНЫХ СЛУЧАЕВ (2026-08-07).**
      ...
      **-60.0 во всех 36 сэмплах**, ни разу не изменилась. Никакого падения нет, и 48 «в воздухе» —
      ...
      ПРОВЕРКА: залогировать `isIsGettingPickaxeFirst` / `_collectingPickaxeForThisResource` /
      результат `miningRequirementMetInventory(STONE)` в этой точке и прогнать `mine_stone` (120 с).
