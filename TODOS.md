...
- [ ] **G-1.35 ВТОРАЯ СТУПЕНЬ: СТОРОЖ СЕТКИ СНОВА ЗАЦИКЛИЛСЯ — ТЕПЕРЬ НА КРОВАТИ (2026-08-07).**
      ...
      **предмет в курсоре не входит в `toMove.getMatches()`** — бот держит бревно, которое рецепт
      ...
      ⛔ СЛЕДУЮЩИЙ ЗАХОД: подтвердить мигание (счётчик на обе ветки ciCollect/ciCraft подряд или
      лог решения раз в тик), и чинить так, чтобы решение «хватает ли материалов» НЕ ЗАВИСЕЛО от
      того, что в курсоре в этот миг.
