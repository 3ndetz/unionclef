...
- [ ] **G-1.36 ДОБЫЧА СЛОМАНА НА САМОМ ПРОСТОМ ИЗ ВОЗМОЖНЫХ СЛУЧАЕВ (2026-08-07).**
      ...
      **-60.0 во всех 36 сэмплах**, ни разу не изменилась. Никакого падения нет, и 48 «в воздухе» —
      ...
      Смотреть, запускается ли она вообще (счётчика у неё нет — поставить), и если да, что мешает:
      трекер сущностей не видит предмет / цель не выбирается / подход не доводится до контакта.
