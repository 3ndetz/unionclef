...
- [ ] **B-33.3 ЧИСЛА @gamer ЗА ЗАГРУЖЕННЫЕ ЧАСЫ 2026-08-06 — НЕДЕЙСТВИТЕЛЬНЫ.**
      ...
      ⛔ ВЫВОД: пока чужой проект держит машину, измерять нечем, и сделать стенд дешевле нельзя.
      Ждать тихого окна — это единственный путь. Клиенты между прогонами держать ОСТАНОВЛЕННЫМИ.
