...
- [ ] **B-33.3 ЧИСЛА @gamer ЗА ЗАГРУЖЕННЫЕ ЧАСЫ 2026-08-06 — НЕДЕЙСТВИТЕЛЬНЫ.**
      ...
      ⛔ ОТДЕЛЬНАЯ ЗАДАЧА, КОТОРУЮ СТОИТ СДЕЛАТЬ: ограничить FPS клиентов стенда (или снизить
      дальность прорисовки) — 370% на простой рендер это чистая потеря, и она бьёт по всем на этой
      машине, включая соседний проект. Мерить до/после через `getPerfStats`.
