...
- [ ] **G-0 СВЯЗНОСТЬ. Пока altoclef импортирует `baritone.*`, удалить shredder нельзя.**
      ...
      * ⏳ ОСТАЛОСЬ ИЗМЕРИТЬ: `pdLegacy` — единственное место, где старый движок ещё может вести
        бота. «Можно ли удалить baritone» = «ноль ли этот счётчик на живом прогоне».
- [ ] **G-1.32 ЦЕПОЧКА ЗАДАЧ КРУТИТСЯ НА «ДОСКАХ» — СНЯТО С ЖИВОГО ПРОГОНА (2026-08-06).**
      ...
      ⛔ ПРАВКА: «план, состоящий из одной точки» означает ПРИБЫЛИ — этап должен завершаться, а не
      перепланироваться. Искать в `FastNavigator` (leg/goal) того, кто ставит цель равной текущей
      позиции, и закрывать этап.
