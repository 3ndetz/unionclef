...
- [ ] **G-1.37 ЧЕТВЁРТАЯ СТУПЕНЬ: ПЛАВКА. Курс заведён, БЛОКЕР ВОСПРОИЗВОДИТСЯ (2026-08-07).**
      ...
      ⛔ СЛЕДУЮЩИЙ ЗАХОД: тем же методом — сначала цепочка задач и счётчики на этом курсе (он
      воспроизводит за 4 минуты на дешёвом мире), и только потом правка.- [ ] **G-1.36 ДОБЫЧА СЛОМАНА НА САМОМ ПРОСТОМ ИЗ ВОЗМОЖНЫХ СЛУЧАЕВ (2026-08-07).**
