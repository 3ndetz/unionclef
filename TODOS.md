...
Причина: TriggerBot.REACH и связанные с ним дистанции (`STRIKE_DISTANCE`,
`MOB_STRIKE_DISTANCE` и т.д., `CombatController.java:29-69`) плотно завязаны на текущую
геометрию гейта — менять его вслепую рискует не только этим багом, но и всей дистанционной
калибровкой боя.
