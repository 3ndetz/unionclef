...
- [ ] **G-1.44 ⭐⭐⭐ ОБЩИЙ КОРЕНЬ ТРЁХ ЗАВИСАНИЙ: `Nav.isPathing()` ГЛУШИТ ВСЕ ПРОГРЕСС-ЧЕКЕРЫ (2026-08-07).**
      ...
      ⛔ ГЕЙТ ДЛЯ ЛЮБОЙ ИЗ НИХ: `chop_canopy` (сейчас 2/4 → ждём стабильно зелёный), `mine_stone`,
      `craft_at_distant_table` (3/5), вся craft-лестница как регрессия, и `cb=` на красных прогонах
      должен перестать показывать 18456 отказов по `shouldAvoidBreaking`.
