...
- [ ] **G-1.51 ⭐⭐⭐ ПОБЕГ ИЗ ЛАВЫ МЁРТВ, И МЕХАНИЗМ — РОВНО ТОТ, ЧТО УЖЕ ПОЧИНЕН ДЛЯ ВОДЫ (2026-08-08).**
      ...
      ⛔ ПОЧЕМУ НЕ ПОЧИНЕНО ПРЯМО СЕЙЧАС: у лавы порт ДВУХЭТАПНЫЙ (сначала вода — в старой эвристике
      она стоила -100, тушит; и только потом «не лава»), это не переименование. Плюс одна проверка,
      которую честно надо сделать перед правкой: поставить счётчик и УБЕДИТЬСЯ, что `setTask`
      реально достигается — сейчас это вывод из двух дефолтов, а не измерение. Сегодня цена такой
      уверенности уже была показана.
