...
- [ ] 20. ДЕМО-РОЛИКИ/GIF (showcase для Discord/GitHub-релизов):
  - ролики: (a) PVP-бот, (b) прыжки на слайме, (c) tungsten ломает+ставит блоки в
    паркуре. Снять на стенде (getScreenshot покадрово), собрать в видео + GIF,
    прислать юзеру в ТГ. Потом залить на GitHub и вставить в релиз-ноты
