...
- [ ] **G-1.32 ЦЕПОЧКА ЗАДАЧ КРУТИТСЯ НА «ДОСКАХ» — СНЯТО С ЖИВОГО ПРОГОНА (2026-08-06).**
      ...
      ⛔ СЛЕДУЮЩИЙ ЗАХОД: читать именно этот путь — раскладку 2x2-рецепта в столе и то, почему
      выход не забирается. Счётчиков у `CraftGenericManuallyTask` НЕТ ни одного; поставить их
      (заполнено/не хватает/взято с выхода/ждём) — тогда ответ придёт с первого прогона, как всегда.
