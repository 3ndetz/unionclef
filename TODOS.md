...
- [ ] **G-1.36 ДОБЫЧА СЛОМАНА НА САМОМ ПРОСТОМ ИЗ ВОЗМОЖНЫХ СЛУЧАЕВ (2026-08-07).**
      ...
      ⭐ ЧТО ЭТО ЗНАЧИТ НА САМОМ ДЕЛЕ: бот ломает пол, НА КОТОРОМ СТОИТ, проваливается и оказывается
      в воздухе — а ворота удара требуют «на земле или в воде». Отсюда 2459 тиков работы и ноль
      булыжника: он падает в собственную яму.
      ⛔ СЛЕДУЮЩИЙ ЗАХОД: (а) подтвердить падение (координата Y бота по ходу прогона — в
      `timeline.jsonl` она есть); (б) решать ПРАВИЛЬНО: цель добычи не должна быть блоком под
      ногами. Это ядро выбора цели, а не заплатка «не ломай под собой» — смотреть, как выбирается
      ближайший блок и почему пол под ногами вообще попадает в кандидаты.
