...
- [ ] **G-1.2 ⛔ ЕДИНСТВЕННЫЙ ОСТАВШИЙСЯ БЛОКЕР ПРОХОДА, ОХАРАКТЕРИЗОВАН ТОЧНО (2026-08-03).**
      ...
      СЛЕДУЮЩИЙ ЗАХОД: читать генерацию преемников (`BlockNode.getChildren` / `SmartMoves`)
      от начала до конца и найти, почему из открытой клетки не рождается ни одного ребёнка.
