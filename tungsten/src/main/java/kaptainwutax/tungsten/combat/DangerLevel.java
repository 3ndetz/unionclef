 ...
 * HEIGHT_HIGH   — 4-5 blocks, fall damage. Triggers DANGER_IMMINENT.
 * HEIGHT_DEATH  — 6+ blocks, lethal/near-lethal fall. Maximum priority brake.
 */
public enum DangerLevel {
    ...
    public static DangerLevel fromFallHeight(int blocks) {
        ...
        if (blocks <= 5) return HEIGHT_HIGH;
        return HEIGHT_DEATH;
    }
