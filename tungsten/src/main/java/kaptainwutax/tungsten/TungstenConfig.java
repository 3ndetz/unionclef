...
public class TungstenConfig {
    ...
    /** Reject pathfinding nodes between adjacent fences/walls.
     *  Prevents getting stuck on ViaVersion servers where fence connections
     *  differ from what the 1.21 client renders. */
