...
import shredder.api.utils.BlockUtils;
import shredder.pathing.movement.MovementHelper;
import shredder.utils.pathing.PathingBlockType;
import java.util.*;
...
import static shredder.utils.BlockStateInterface.getFromChunk;
                    ...
                    for (int z = 0; z < 16; z++) {
                        for (int x = 0; x < 16; x++) {
                            ...
                            if (CachedChunk.BLOCKS_TO_KEEP_TRACK_OF.contains(block)) {
                                ...
                                specialBlocks.computeIfAbsent(name, b -> new ArrayList<>()).add(new BlockPos(x, y+chunk.getBottomY(), z));
                            }
                        }
                    }
                }
