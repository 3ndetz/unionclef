...
import shredder.pathing.calc.openset.BinaryHeapOpenSet;
import shredder.pathing.movement.CalculationContext;
import shredder.pathing.movement.Moves;
import shredder.utils.pathing.BetterWorldBorder;
...
public final class AStarPathFinder extends AbstractNodeCostSearch {
    ...
    protected Optional<IPath> calculate0(long primaryTimeout, long failureTimeout) {
        ...
        if (Baritone.settings().debugPrintPathMovements.value) {
