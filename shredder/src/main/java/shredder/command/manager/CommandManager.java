...
package shredder.command.manager;
...
import shredder.api.command.exception.CommandUnhandledException;
import shredder.api.command.exception.ICommandException;
import shredder.api.command.helpers.TabCompleteHelper;
import shredder.api.command.manager.ICommandManager;
import shredder.api.command.registry.Registry;
import shredder.command.argument.ArgConsumer;
import shredder.command.argument.CommandArguments;
import shredder.command.defaults.DefaultCommands;
