...
package shredder.command.argument;
...
import shredder.api.command.datatypes.IDatatype;
import shredder.api.command.datatypes.IDatatypeContext;
import shredder.api.command.datatypes.IDatatypeFor;
import shredder.api.command.datatypes.IDatatypePost;
...
import shredder.api.command.exception.CommandTooManyArgumentsException;
