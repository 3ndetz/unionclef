...
package shredder.utils.schematic.format.defaults;
...
public final class LitematicaSchematic extends StaticSchematic {
     ...
     */
    private void writeSubregionIntoSchematic(NbtCompound nbt, String subReg, BlockState[] blockList, LitematicaBitArray bitArray) {
