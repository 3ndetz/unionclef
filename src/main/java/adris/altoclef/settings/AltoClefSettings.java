 ...
 *
 * MOVED OUT OF THE BARITONE PACKAGE (G-0, 2026-08-24).
 *
 * <p>This class never depended on a single baritone type -- only its package line did. It is
 * altoclef's own settings holder and it lived in baritone/ purely by history, which is why
 * seventeen altoclef call sites had to import a baritone package to read their own config.
 * The LGPL header stays because the file's licence travels with it.
 */

package adris.altoclef.settings;
