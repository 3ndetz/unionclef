    ...
    public String placeStats() {
        ...
        return String.format(
                "called=%d deferred=%d inRange=%d clicked=%d noSup=%d/%d/%d"
                        ...
                        + " entityReleased=%d/%d idrop=%d/%d/%d/%d rt=%d/%d/%d entityCloseWalk=%d/%d/%d/%d/%d/%d/%d closeWalkGeom=%d/%d/%d/%d deep=%d/%d/%d cwJump=%d closeWalkFwd=%d/%d/%d",
