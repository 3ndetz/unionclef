...
public class Py4jEntryPoint {
    ...
    public Map<String, Object> lavaEntryStats() {
        ...
        // Second pass (see the field docs): the fall VECTOR and WHO owned the legs, because the
        // first pass read a knockback out of a signature whose zero horizontal speed argues against
        // one, and vgCalls=0 / reposition=0 say the combat pipeline was not driving at all.
        out.put("prev1", adris.altoclef.chains.WorldSurvivalChain.lavaEntryPrev1);
        out.put("prev10", adris.altoclef.chains.WorldSurvivalChain.lavaEntryPrev10);
        out.put("driver", adris.altoclef.chains.WorldSurvivalChain.lavaEntryDriver);
    ...
    /**
     * WHERE THE COARSE GUIDE LEADS AGAINST WHERE THE PHYSICS ACTUALLY STOPS.
     *
     * <p>One line per search that ended with no route while it still held a guide, newest last:
     * the guide's length, the index the physics reached along it, the body and frontier positions,
     * how far the guide's own end sits from the goal, and the hop the physics never crossed with
     * the blocks below/at/above both of its ends.
     *
     * <p>Call it after a stall to answer "does the guide point somewhere the physics cannot step",
     * which counters alone cannot: guide length and reached-index only mean anything paired.
     */
    public String guideDump() {
        return kaptainwutax.tungsten.path.PathFinder.gvpDumpText();
    }

    /** The shapes (dx,dy,dz) of those un-crossed hops, commonest first. "END" means the physics
     *  walked the whole guide and the guide itself stopped short of the goal. */
    public String guideHopShapes() {
        return kaptainwutax.tungsten.path.PathFinder.gvpHopDump();
    }
    ...
    public java.util.Map<String, Object> resetRunCounters() {
        ...
        kaptainwutax.tungsten.path.PathExecutor.execDigYieldMiner = 0;
        adris.altoclef.control.Nav.oreCoalSeen = 0;
        adris.altoclef.control.Nav.oreIronSeen = 0;
        adris.altoclef.control.Nav.oreSample = 0;
        ...
        adris.altoclef.tasks.construction.DestroyBlockTask.dbBuilderYield = 0;
        adris.altoclef.tasks.construction.DestroyBlockTask.dbBuildHeldStuck = 0;
        ...
        adris.altoclef.tasks.AbstractDoToClosestObjectTask.dcNone = 0;
        adris.altoclef.tasks.AbstractDoToClosestObjectTask.dcSame = 0;
        adris.altoclef.tasks.AbstractDoToClosestObjectTask.dcGaveUp = 0;
        adris.altoclef.tasks.AbstractDoToClosestObjectTask.dcClockReset = 0;
        adris.altoclef.tasks.AbstractDoToClosestObjectTask.dcResetJumpCm = 0;
        adris.altoclef.tasks.AbstractDoToClosestObjectTask.dcMoving = 0;
        adris.altoclef.tasks.AbstractDoToClosestObjectTask.dcStill = 0;
        adris.altoclef.tasks.AbstractDoToClosestObjectTask.dcGaveUpIdle = 0;
        adris.altoclef.tasks.AbstractDoToClosestObjectTask.dcStillNear = 0;
        adris.altoclef.tasks.AbstractDoToClosestObjectTask.dcStillFar = 0;
        ...
        adris.altoclef.control.Nav.stallWhyLock = 0;
        adris.altoclef.control.Nav.stallWhySearch = 0;
        adris.altoclef.control.Nav.stallWhyExec = 0;
        adris.altoclef.control.Nav.stallWhyQueue = 0;
        adris.altoclef.control.Nav.stallWhyWalker = 0;
        adris.altoclef.control.Nav.stallExecBreak = 0;
        adris.altoclef.control.Nav.stallExecPlace = 0;
        adris.altoclef.control.Nav.stallExecReplay = 0;
        adris.altoclef.control.Nav.stallExecArmed = 0;
        adris.altoclef.control.Nav.stallExecIdxStuck = 0;
        adris.altoclef.control.Nav.stallExecWorkSeen = 0;
        adris.altoclef.control.Nav.stallExecWorkBlind = 0;
        adris.altoclef.control.Nav.stallExecMining = 0;
        adris.altoclef.control.Nav.stallExecQueuedOnly = 0;
        adris.altoclef.control.Nav.stallExecPlacingOnly = 0;
        kaptainwutax.tungsten.path.PathExecutor.mineHits = 0;
        kaptainwutax.tungsten.path.PathExecutor.mineNoProgress = 0;
        adris.altoclef.control.InputControls.clearAttackStealers();
        adris.altoclef.chains.MobDefenseChain.fireReleaseSkipped = 0;
        kaptainwutax.tungsten.path.PathExecutor.breakOnTarget = 0;
        kaptainwutax.tungsten.path.PathExecutor.breakOffTarget = 0;
        kaptainwutax.tungsten.path.PathExecutor.breakAimedElsewhere = 0;
        kaptainwutax.tungsten.path.PathExecutor.breakAimedAtNothing = 0;
        kaptainwutax.tungsten.path.PathExecutor.breakAbortTimeout = 0;
        kaptainwutax.tungsten.path.PathExecutor.breakAbortReach = 0;
        kaptainwutax.tungsten.path.PathExecutor.breakReachNear = 0;
        kaptainwutax.tungsten.path.PathExecutor.breakReachMid = 0;
        kaptainwutax.tungsten.path.PathExecutor.breakReachFar = 0;
        kaptainwutax.tungsten.path.PathExecutor.lastReachAbort = "-";
        kaptainwutax.tungsten.path.PathExecutor.breakOccluded = 0;
        kaptainwutax.tungsten.path.PathExecutor.breakAimInTransit = 0;
        kaptainwutax.tungsten.path.PathExecutor.breakOccluderInPlan = 0;
        ...
        adris.altoclef.tasks.movement.TimeoutWanderTask.wanderTungPicked = 0;
        adris.altoclef.tasks.movement.TimeoutWanderTask.wanderTargetUnstandable = 0;
        adris.altoclef.tasks.movement.TimeoutWanderTask.wanderSpiralHeld = 0;
        adris.altoclef.tasks.movement.TimeoutWanderTask.wanderTungDriven = 0;
        kaptainwutax.tungsten.path.PathFinder.emptyPathRefused = 0;
        kaptainwutax.tungsten.path.PathFinder.guideVanished = 0;
        kaptainwutax.tungsten.path.PathFinder.guideVanishedSalvaged = 0;
        kaptainwutax.tungsten.path.PathFinder.searchAborted = 0;
        kaptainwutax.tungsten.path.PathFinder.emitCount = 0;
        kaptainwutax.tungsten.path.PathFinder.emitTotalNodes = 0;
        kaptainwutax.tungsten.path.PathFinder.emitFresh = 0;
        kaptainwutax.tungsten.path.PathFinder.emitAppended = 0;
        kaptainwutax.tungsten.path.PathFinder.tryEmitCalls = 0;
        kaptainwutax.tungsten.path.PathFinder.tryEmitStationary = 0;
        kaptainwutax.tungsten.path.PathFinder.tryEmitMoving = 0;
        ...
        kaptainwutax.tungsten.path.PathFinder.gvpSamples = 0;
        kaptainwutax.tungsten.path.PathFinder.gvpTinyGuide = 0;
        kaptainwutax.tungsten.path.PathFinder.gvpStuckAtStart = 0;
        kaptainwutax.tungsten.path.PathFinder.gvpReachedGuideEnd = 0;
        kaptainwutax.tungsten.path.PathFinder.gvpNoGuide = 0;
        kaptainwutax.tungsten.path.PathFinder.guideFromFast = 0;
        kaptainwutax.tungsten.path.PathFinder.guideFromFastNowhere = 0;
        kaptainwutax.tungsten.path.PathFinder.guideFromCoarse = 0;
        kaptainwutax.tungsten.path.PathFinder.guideFromCoarseNowhere = 0;
        kaptainwutax.tungsten.path.PathFinder.truncCut = 0;
        kaptainwutax.tungsten.path.PathFinder.truncCutToOneNode = 0;
        kaptainwutax.tungsten.path.PathFinder.fastNowhereTruncated = 0;
        kaptainwutax.tungsten.path.PathFinder.fastNowhereOther = 0;
        kaptainwutax.tungsten.path.PathFinder.clearCoarseNowhere();
        kaptainwutax.tungsten.path.PathFinder.gvpHopShapes.clear();
        kaptainwutax.tungsten.path.PathFinder.gvpClearDumps();
        kaptainwutax.tungsten.path.blockSpaceSearchAssist.BlockNode.fallCheckRun = 0;
        kaptainwutax.tungsten.path.blockSpaceSearchAssist.BlockNode.fallCheckRefused = 0;
        kaptainwutax.tungsten.path.blockSpaceSearchAssist.BlockNode.smartKept = 0;
        kaptainwutax.tungsten.path.blockSpaceSearchAssist.BlockNode.smartDropped = 0;
        kaptainwutax.tungsten.path.PathFinder.resumeLetItFinish = 0;
        kaptainwutax.tungsten.path.PathFinder.stopBy.clear();
        kaptainwutax.tungsten.path.PathFinder.stallSpared = 0;
        kaptainwutax.tungsten.path.blockSpaceSearchAssist.BlockSpacePathFinder.bsComplete = 0;
        kaptainwutax.tungsten.path.blockSpaceSearchAssist.BlockSpacePathFinder.bsTimeout = 0;
        kaptainwutax.tungsten.path.blockSpaceSearchAssist.BlockSpacePathFinder.bsStopped = 0;
        kaptainwutax.tungsten.path.blockSpaceSearchAssist.BlockSpacePathFinder.bsExhausted = 0;
        kaptainwutax.tungsten.path.blockSpaceSearchAssist.BlockSpacePathFinder.bsClosestCm = 0;
        kaptainwutax.tungsten.path.blockSpaceSearchAssist.BlockSpacePathFinder.bsFindCalls = 0;
        kaptainwutax.tungsten.path.blockSpaceSearchAssist.BlockSpacePathFinder.bsSearchCalls = 0;
        kaptainwutax.tungsten.path.blockSpaceSearchAssist.BlockSpacePathFinder.bsLoopIters = 0;
        kaptainwutax.tungsten.path.blockSpaceSearchAssist.BlockSpacePathFinder.bsStub = 0;
        kaptainwutax.tungsten.path.blockSpaceSearchAssist.BlockSpacePathFinder.bsStubHadCloser = 0;
        kaptainwutax.tungsten.path.blockSpaceSearchAssist.BlockSpacePathFinder.bsStubCloserCm = 0;
        kaptainwutax.tungsten.path.blockSpaceSearchAssist.BlockSpacePathFinder.bsClosestUsed = 0;
        kaptainwutax.tungsten.path.PathFinder.salvageEmit = 0;
        kaptainwutax.tungsten.path.PathFinder.salvageEmitNodes = 0;
        kaptainwutax.tungsten.path.PathFinder.resetEmit = 0;
        kaptainwutax.tungsten.path.PathFinder.resetEmitNodes = 0;
        kaptainwutax.tungsten.path.PathFinder.resetEmitRefused = 0;
        kaptainwutax.tungsten.path.PathFinder.resetNoGain = 0;
        kaptainwutax.tungsten.path.PathFinder.rawChildren = 0;
        kaptainwutax.tungsten.path.PathFinder.validAfterFilter = 0;
        kaptainwutax.tungsten.path.PathFinder.expandedChildren = 0;
        kaptainwutax.tungsten.path.Node.rejJumpSneak = 0;
        kaptainwutax.tungsten.path.Node.rejAtWaypoint = 0;
        kaptainwutax.tungsten.path.Node.rejSneakAir = 0;
        kaptainwutax.tungsten.path.Node.rejSneakJump = 0;
        kaptainwutax.tungsten.path.Node.paramsOffered = 0;
        kaptainwutax.tungsten.path.Node.createCalls = 0;
        kaptainwutax.tungsten.path.Node.sweepKept = 0;
        kaptainwutax.tungsten.path.Node.sweepNarrowed = 0;
        kaptainwutax.tungsten.path.PathFinder.salvageEmit = 0;
        kaptainwutax.tungsten.path.PathFinder.salvageEmitNodes = 0;
        ...
        kaptainwutax.tungsten.path.Node.fallHarmlessAllowed = 0;
        kaptainwutax.tungsten.path.blockSpaceSearchAssist.BlockNode.blockFallHarmless = 0;
        kaptainwutax.tungsten.path.Node.fallPriced = 0;
        kaptainwutax.tungsten.path.blockSpaceSearchAssist.BlockNode.blockFallPriced = 0;
        kaptainwutax.tungsten.path.PathFinder.gaveUpFallRetry = 0;
        kaptainwutax.tungsten.path.PathFinder.wallSkipRefused = 0;
        kaptainwutax.tungsten.path.PathFinder.wallAlreadyAir = 0;
        kaptainwutax.tungsten.path.PathExecutor.gotoResumedFromSearch = 0;
        ...
        adris.altoclef.util.helpers.TungstenHelper.lockDroppedIdle = 0;
        ...
        adris.altoclef.util.helpers.TungstenHelper.lockTicks = 0;
        adris.altoclef.util.helpers.TungstenHelper.lockSearching = 0;
        adris.altoclef.util.helpers.TungstenHelper.lockExecuting = 0;
        adris.altoclef.util.helpers.TungstenHelper.lockWalking = 0;
        adris.altoclef.util.helpers.TungstenHelper.lockQueue = 0;
        adris.altoclef.util.helpers.TungstenHelper.lockIdle = 0;
        adris.altoclef.util.helpers.TungstenHelper.lockMoved = 0;
        adris.altoclef.util.helpers.TungstenHelper.lockRetargetDone = 0;
        adris.altoclef.util.helpers.TungstenHelper.lockRetargetSkipped = 0;
        ...
        kaptainwutax.tungsten.task.FastNavigator.navCeilingRefused = 0;
        kaptainwutax.tungsten.task.FastNavigator.navBudgetBoosted = 0;
        kaptainwutax.tungsten.task.FastNavigator.navStallReplans = 0;
        kaptainwutax.tungsten.task.FastNavigator.navStallGaveUp = 0;
        kaptainwutax.tungsten.task.FastNavigator.navBreakStarted = 0;
        kaptainwutax.tungsten.task.FastNavigator.navBreakTooFar = 0;
        kaptainwutax.tungsten.task.FastNavigator.navBreakResumed = 0;
        kaptainwutax.tungsten.task.FastNavigator.navPillarRuns = 0;
        kaptainwutax.tungsten.task.PillarTask.pillarCenterTimeout = 0;
        kaptainwutax.tungsten.task.PillarTask.pillarNoHeadroom = 0;
        kaptainwutax.tungsten.task.FastNavigator.navPillarSteered = 0;
        kaptainwutax.tungsten.task.FastNavigator.navHandoffSettled = 0;
        kaptainwutax.tungsten.task.FastNavigator.navHandoffSettleTimeout = 0;
        kaptainwutax.tungsten.path.PathFinder.pfRootMoving = 0;
        kaptainwutax.tungsten.task.FastNavigator.navTowerAllowedFarGoal = 0;
        kaptainwutax.tungsten.task.FastNavigator.navPartialBuildWalked = 0;
        adris.altoclef.chains.MobDefenseChain.mdCreeperAvoid = 0;
        kaptainwutax.tungsten.path.fast.FastPlanner.planPartialByCoef = 0;
        kaptainwutax.tungsten.path.fast.FastPlanner.planStartSnapRefusedOnGround = 0;
        adris.altoclef.tasks.movement.GetToEntityTask.entityLongHaul = 0;
        adris.altoclef.tasks.movement.GetToEntityTask.entityCloseWalkImmediate = 0;
        adris.altoclef.tasks.entity.AbstractKillEntityTask.kaClosedInBand = 0;
        adris.altoclef.tasks.entity.AbstractKillEntityTask.kaMobTicks = 0;
        adris.altoclef.tasks.entity.AbstractKillEntityTask.kaMobClosing = 0;
        adris.altoclef.tasks.entity.AbstractKillEntityTask.kaMobSwings = 0;
        adris.altoclef.tasks.entity.AbstractKillEntityTask.kaMobHandoff = 0;
        adris.altoclef.tasks.entity.AbstractKillEntityTask.kaMobYielded = 0;
        kaptainwutax.tungsten.helpers.BlockPlaceHelper.throwawayRestocked = 0;
        kaptainwutax.tungsten.helpers.BlockPlaceHelper.throwawayRefused = 0;
        kaptainwutax.tungsten.task.PillarTask.pillarColumnRefused = 0;
        kaptainwutax.tungsten.task.FastNavigator.navTowerRefusedBelow = 0;
        adris.altoclef.trackers.BlockScanner.scanCoolOffLifted = 0;
        adris.altoclef.trackers.EntityTracker.entityCoolOffLifted = 0;
        adris.altoclef.tasks.AbstractDoToClosestObjectTask.dcBanLifted = 0;
        adris.altoclef.trackers.blacklisting.AbstractObjectBlacklist.blacklistExpired = 0;
        adris.altoclef.tasks.construction.DestroyBlockTask.dbLidDug = 0;
        adris.altoclef.tasks.construction.DestroyBlockTask.dbLidNoReach = 0;
        kaptainwutax.tungsten.path.movements.MovementSwim.swimLevelAimTicks = 0;
        kaptainwutax.tungsten.task.FastNavigator.navWetLegQueued = 0;
        kaptainwutax.tungsten.task.FastNavigator.navWetLegRefused = 0;
        kaptainwutax.tungsten.task.BlockPathWalker.walkerIntoHole = 0;
        kaptainwutax.tungsten.task.PillarTask.pillarVineTicks = 0;
        kaptainwutax.tungsten.task.PillarTask.pillarVineMet = 0;
        kaptainwutax.tungsten.path.PlaceRules.placeRefusedRecently = 0;
        kaptainwutax.tungsten.task.FastNavigator.navPhysicsFailed = 0;
        kaptainwutax.tungsten.task.FastNavigator.navPhysicsGaveUp = 0;
        kaptainwutax.tungsten.path.PathFinder.physicsBudgetOut = 0;
        kaptainwutax.tungsten.path.PathFinder.physicsBudgetOutSalvaged = 0;
        kaptainwutax.tungsten.task.FastNavigator.navArrivalRefusedByGoal = 0;
        adris.altoclef.chains.MobDefenseChain.mdCreeperUnseenNear = 0;
        adris.altoclef.chains.PlayerInteractionFixChain.fixToolSwaps = 0;
        ...
        adris.altoclef.control.SlotHandler.shCallers.clear();
        adris.altoclef.control.SlotHandler.shRefreshes = 0;
        adris.altoclef.control.SlotHandler.shRefreshWithCursor = 0;
        adris.altoclef.tasks.InteractWithBlockTask.iwCantReach = 0;
        adris.altoclef.tasks.InteractWithBlockTask.iwWaiting = 0;
        adris.altoclef.tasks.InteractWithBlockTask.iwClicked = 0;
        adris.altoclef.tasks.InteractWithBlockTask.iwWanderFallback = 0;
        kaptainwutax.tungsten.task.FastNavigator.navShortRes = 0;
        kaptainwutax.tungsten.combat.CombatPathfinder.cpCalls = 0;
        kaptainwutax.tungsten.combat.CombatPathfinder.cpExhausted = 0;
        kaptainwutax.tungsten.combat.CombatPathfinder.cpStub = 0;
        kaptainwutax.tungsten.combat.CombatPathfinder.cpCells = 0;
        kaptainwutax.tungsten.combat.CombatPathfinder.cpDistinct = 0;
        kaptainwutax.tungsten.combat.CombatPathfinder.gridDiagonalDropped = 0;
        kaptainwutax.tungsten.combat.CombatPathfinder.gridDiagonalExpanded = 0;
        kaptainwutax.tungsten.combat.CombatPathfinder.gridDiagonalUnturnable = 0;
        kaptainwutax.tungsten.path.fast.FastPlanner.planCalls = 0;
        kaptainwutax.tungsten.path.fast.FastPlanner.planLastExpanded = 0;
        kaptainwutax.tungsten.path.fast.FastPlanner.planLastMs = 0;
        kaptainwutax.tungsten.path.fast.FastPlanner.planLastSize = 0;
        kaptainwutax.tungsten.path.fast.FastPlanner.planZeroExpand = 0;
        kaptainwutax.tungsten.path.fast.FastPlanner.planExpand0 = 0;
        kaptainwutax.tungsten.path.fast.FastPlanner.planExpand1 = 0;
        kaptainwutax.tungsten.path.fast.FastPlanner.planStartRescued = 0;
        kaptainwutax.tungsten.path.fast.FastPlanner.planStartSnapped = 0;
        kaptainwutax.tungsten.path.fast.FastPlanner.planStartNoSupport = 0;
        kaptainwutax.tungsten.path.fast.FastPlanner.planStartSupportedNoKids = 0;
        kaptainwutax.tungsten.path.fast.FastPlanner.planStartIsGoal = 0;
        ...
        kaptainwutax.tungsten.task.FastNavigator.navOkRes = 0;
        ...
        adris.altoclef.tasks.entity.AbstractDoToEntityTask.dteItemNearNotHittable = 0;
        ...
        adris.altoclef.chains.UnstuckChain.rescueNearPrevious = 0;
        adris.altoclef.tasks.AbstractDoToClosestObjectTask.dcReofferedBanned = 0;
        adris.altoclef.tasks.AbstractDoToClosestObjectTask.dcRefusedBanned = 0;
        adris.altoclef.util.helpers.TungstenHelper.tpNotLoaded = 0;
        adris.altoclef.util.helpers.TungstenHelper.tpFailCount = 0;
        adris.altoclef.util.helpers.TungstenHelper.tpBarren = 0;
        adris.altoclef.util.helpers.TungstenHelper.tpCooldown = 0;
        adris.altoclef.util.helpers.TungstenHelper.tpBarrenBypassed = 0;
        adris.altoclef.tasks.resources.MineAndCollectTask.MineOrCollectTask.minePickFar = 0;
        adris.altoclef.tasks.resources.MineAndCollectTask.MineOrCollectTask.minePickTotal = 0;
        adris.altoclef.tasks.resources.MineAndCollectTask.MineOrCollectTask.minePickFarthest = 0;
        adris.altoclef.tasks.resources.MineAndCollectTask.MineOrCollectTask.minePickCalls = 0;
        adris.altoclef.tasks.resources.MineAndCollectTask.MineOrCollectTask.minePickDrop = 0;
        adris.altoclef.tasks.AbstractDoToClosestObjectTask.dcPursuitFarthest = 0;
        adris.altoclef.chains.UnstuckChain.rescueMovedOn = 0;
        adris.altoclef.tasks.resources.MineAndCollectTask.mineRetarget = 0;
        adris.altoclef.tasks.resources.MineAndCollectTask.mineRetargetCm = 0;
        adris.altoclef.tasks.resources.MineAndCollectTask.mineRetargetBack = 0;
        adris.altoclef.tasks.speedrun.beatgame.BeatMinecraftTask.thrownByType.clear();
        adris.altoclef.tasksystem.TaskRunner.chainTicks.clear();
        adris.altoclef.chains.UnstuckChain.strandedSkippedDigging = 0;
        adris.altoclef.chains.UnstuckChain.unstuckOwnedTicks = 0;
        adris.altoclef.chains.UnstuckChain.unstuckAcrobaticsSuppressed = 0;
    ...
    public String placeStats() {
        ...
        return String.format(
                ...
                kaptainwutax.tungsten.path.PathExecutor.execDigYieldMiner,
                adris.altoclef.control.Nav.oreCoalSeen,
                adris.altoclef.control.Nav.oreIronSeen,
                adris.altoclef.control.Nav.oreSample,
                ...
                adris.altoclef.tasks.construction.DestroyBlockTask.dbBuilderYield,
                adris.altoclef.tasks.construction.DestroyBlockTask.dbBuildHeldStuck,
                adris.altoclef.tasks.InteractWithBlockTask.iwCantReach,
                adris.altoclef.tasks.InteractWithBlockTask.iwWaiting,
                adris.altoclef.tasks.InteractWithBlockTask.iwClicked,
                adris.altoclef.tasks.InteractWithBlockTask.iwWanderFallback,
                ...
                adris.altoclef.control.SlotHandler.shRefreshes,
                adris.altoclef.control.SlotHandler.shRefreshWithCursor,
                adris.altoclef.control.SlotHandler.shCallersDump(),
                adris.altoclef.chains.PlayerInteractionFixChain.fixKeptCursor,
                adris.altoclef.tasks.speedrun.beatgame.BeatMinecraftTask.thrownDump(),
                ...
                kaptainwutax.tungsten.task.FastNavigator.navCeilingRefused,
                kaptainwutax.tungsten.task.FastNavigator.navBudgetBoosted,
                kaptainwutax.tungsten.task.FastNavigator.navStallReplans,
                kaptainwutax.tungsten.task.FastNavigator.navStallGaveUp,
                kaptainwutax.tungsten.task.FastNavigator.navBreakStarted,
                kaptainwutax.tungsten.task.FastNavigator.navBreakTooFar,
                kaptainwutax.tungsten.task.FastNavigator.navBreakResumed,
                kaptainwutax.tungsten.task.FastNavigator.navPillarRuns,
                kaptainwutax.tungsten.task.PillarTask.pillarCenterTimeout,
                kaptainwutax.tungsten.task.PillarTask.pillarNoHeadroom,
                kaptainwutax.tungsten.task.FastNavigator.navPillarSteered,
                kaptainwutax.tungsten.task.FastNavigator.navHandoffSettled,
                kaptainwutax.tungsten.task.FastNavigator.navHandoffSettleTimeout,
                kaptainwutax.tungsten.path.PathFinder.pfRootMoving,
                kaptainwutax.tungsten.task.FastNavigator.navTowerAllowedFarGoal,
                kaptainwutax.tungsten.task.FastNavigator.navPartialBuildWalked,
                adris.altoclef.chains.MobDefenseChain.mdCreeperAvoid,
                kaptainwutax.tungsten.path.fast.FastPlanner.planPartialByCoef,
                kaptainwutax.tungsten.path.fast.FastPlanner.planStartSnapRefusedOnGround,
                adris.altoclef.tasks.movement.GetToEntityTask.entityLongHaul,
                adris.altoclef.tasks.movement.GetToEntityTask.entityCloseWalkImmediate,
                adris.altoclef.tasks.entity.AbstractKillEntityTask.kaClosedInBand,
                adris.altoclef.tasks.entity.AbstractKillEntityTask.kaMobTicks,
                adris.altoclef.tasks.entity.AbstractKillEntityTask.kaMobClosing,
                adris.altoclef.tasks.entity.AbstractKillEntityTask.kaMobSwings,
                adris.altoclef.tasks.entity.AbstractKillEntityTask.kaMobHandoff,
                adris.altoclef.tasks.entity.AbstractKillEntityTask.kaMobYielded,
                kaptainwutax.tungsten.helpers.BlockPlaceHelper.throwawayRestocked,
                kaptainwutax.tungsten.helpers.BlockPlaceHelper.throwawayRefused,
                kaptainwutax.tungsten.task.PillarTask.pillarColumnRefused,
                kaptainwutax.tungsten.task.FastNavigator.navTowerRefusedBelow,
                adris.altoclef.trackers.BlockScanner.scanCoolOffLifted,
                adris.altoclef.trackers.EntityTracker.entityCoolOffLifted,
                adris.altoclef.tasks.AbstractDoToClosestObjectTask.dcBanLifted,
                adris.altoclef.trackers.blacklisting.AbstractObjectBlacklist.blacklistExpired,
                adris.altoclef.tasks.construction.DestroyBlockTask.dbLidDug,
                adris.altoclef.tasks.construction.DestroyBlockTask.dbLidNoReach,
                kaptainwutax.tungsten.path.movements.MovementSwim.swimLevelAimTicks,
                kaptainwutax.tungsten.task.FastNavigator.navWetLegQueued,
                kaptainwutax.tungsten.task.FastNavigator.navWetLegRefused,
                kaptainwutax.tungsten.task.BlockPathWalker.walkerIntoHole,
                kaptainwutax.tungsten.task.PillarTask.pillarVineTicks,
                kaptainwutax.tungsten.task.PillarTask.pillarVineMet,
                kaptainwutax.tungsten.path.PlaceRules.placeRefusedRecently,
                kaptainwutax.tungsten.task.FastNavigator.navPhysicsFailed,
                kaptainwutax.tungsten.task.FastNavigator.navPhysicsGaveUp,
                kaptainwutax.tungsten.path.PathFinder.physicsBudgetOut,
                kaptainwutax.tungsten.path.PathFinder.physicsBudgetOutSalvaged,
                kaptainwutax.tungsten.task.FastNavigator.navArrivalRefusedByGoal,
                adris.altoclef.chains.MobDefenseChain.mdCreeperUnseenNear,
                adris.altoclef.chains.PlayerInteractionFixChain.fixToolSwaps,
                ...
                adris.altoclef.tasks.movement.PickupDroppedItemTask.pursuitMaxSec,
                ...
                kaptainwutax.tungsten.path.fast.FastPlanner.planCalls,
                kaptainwutax.tungsten.path.fast.FastPlanner.planLastExpanded,
                kaptainwutax.tungsten.path.fast.FastPlanner.planLastMs,
                kaptainwutax.tungsten.path.fast.FastPlanner.planLastSize,
                kaptainwutax.tungsten.path.fast.FastPlanner.planZeroExpand,
                kaptainwutax.tungsten.path.fast.FastPlanner.planExpand0,
                kaptainwutax.tungsten.path.fast.FastPlanner.planExpand1,
                kaptainwutax.tungsten.path.fast.FastPlanner.planStartRescued,
                kaptainwutax.tungsten.path.fast.FastPlanner.planStartSnapped,
                kaptainwutax.tungsten.path.fast.FastPlanner.planStartNoSupport,
                kaptainwutax.tungsten.path.fast.FastPlanner.planStartSupportedNoKids,
                kaptainwutax.tungsten.path.fast.FastPlanner.planStartIsGoal,
                kaptainwutax.tungsten.path.fast.FastPlanner.planAtGoalExact,
                kaptainwutax.tungsten.path.fast.FastPlanner.planAtGoalYTol,
                kaptainwutax.tungsten.path.fast.FastPlanner.planAtGoalDump(),
                kaptainwutax.tungsten.combat.CombatPathfinder.cpCalls,
                kaptainwutax.tungsten.combat.CombatPathfinder.cpExhausted,
                kaptainwutax.tungsten.combat.CombatPathfinder.cpStub,
                kaptainwutax.tungsten.combat.CombatPathfinder.cpCells,
                kaptainwutax.tungsten.combat.CombatPathfinder.cpDistinct,
                kaptainwutax.tungsten.combat.CombatPathfinder.gridDiagonalDropped,
                kaptainwutax.tungsten.combat.CombatPathfinder.gridDiagonalExpanded,
                kaptainwutax.tungsten.combat.CombatPathfinder.gridDiagonalUnturnable,
                kaptainwutax.tungsten.task.FastNavigator.navShortRes,
                kaptainwutax.tungsten.task.FastNavigator.navEmptyRes,
                kaptainwutax.tungsten.task.FastNavigator.navIncomplete,
                kaptainwutax.tungsten.task.FastNavigator.navDeadEnd,
                kaptainwutax.tungsten.task.FastNavigator.navOkRes,
                kaptainwutax.tungsten.task.FastNavigator.navBridgeRescued,
                kaptainwutax.tungsten.task.BlockPathWalker.walkerHoleHeld,
                kaptainwutax.tungsten.task.BlockPathWalker.dirHazardAhead,
                kaptainwutax.tungsten.task.BlockPathWalker.walkerLavaHeld,
                ...
                kaptainwutax.tungsten.path.RouteHazards.segmentsChecked,
                kaptainwutax.tungsten.task.BlockPathWalker.guardYieldedToRoute,
                kaptainwutax.tungsten.combat.CombatPathfinder.cpLavaMarginKept,
                kaptainwutax.tungsten.combat.CombatPathfinder.cpLavaMarginDropped,
                kaptainwutax.tungsten.combat.CombatPathfinder.cpCliffMargin,
                adris.altoclef.tasks.construction.DestroyBlockTask.underfootRefused,
                kaptainwutax.tungsten.task.BlockPathWalker.walkerNoSprintOvershoot,
                kaptainwutax.tungsten.path.BreakRules.refusedNextToLava,
                ...
                adris.altoclef.tasks.resources.MineAndCollectTask.mineRetarget,
                adris.altoclef.tasks.resources.MineAndCollectTask.mineRetargetCm,
                adris.altoclef.tasks.resources.MineAndCollectTask.mineRetargetBack,
                ...
                adris.altoclef.tasks.AbstractDoToClosestObjectTask.dcNone,
                adris.altoclef.tasks.AbstractDoToClosestObjectTask.dcSame,
                adris.altoclef.tasks.AbstractDoToClosestObjectTask.dcGaveUp,
                adris.altoclef.tasks.AbstractDoToClosestObjectTask.dcClockReset,
                adris.altoclef.tasks.AbstractDoToClosestObjectTask.dcResetJumpCm,
                adris.altoclef.tasks.AbstractDoToClosestObjectTask.dcMoving,
                adris.altoclef.tasks.AbstractDoToClosestObjectTask.dcStill,
                adris.altoclef.tasks.AbstractDoToClosestObjectTask.dcGaveUpIdle,
                adris.altoclef.tasks.AbstractDoToClosestObjectTask.dcStillNear,
                adris.altoclef.tasks.AbstractDoToClosestObjectTask.dcStillFar,
                ...
                adris.altoclef.tasks.movement.TimeoutWanderTask.wanderTungPicked,
                adris.altoclef.tasks.movement.TimeoutWanderTask.wanderTungDriven,
                adris.altoclef.tasks.movement.TimeoutWanderTask.wanderTargetUnstandable,
                adris.altoclef.tasks.movement.TimeoutWanderTask.wanderTargetUnstandable,
                adris.altoclef.tasks.movement.TimeoutWanderTask.wanderSpiralHeld,
                adris.altoclef.control.Nav.stallWhyLock,
                adris.altoclef.control.Nav.stallWhySearch,
                adris.altoclef.control.Nav.stallWhyExec,
                adris.altoclef.control.Nav.stallWhyQueue,
                adris.altoclef.control.Nav.stallWhyWalker,
                adris.altoclef.control.Nav.stallExecBreak,
                adris.altoclef.control.Nav.stallExecPlace,
                adris.altoclef.control.Nav.stallExecReplay,
                adris.altoclef.control.Nav.stallExecArmed,
                adris.altoclef.control.Nav.stallExecIdxStuck,
                adris.altoclef.control.Nav.stallExecWorkSeen,
                adris.altoclef.control.Nav.stallExecWorkBlind,
                adris.altoclef.control.Nav.stallExecMining,
                adris.altoclef.control.Nav.stallExecQueuedOnly,
                adris.altoclef.control.Nav.stallExecPlacingOnly,
                kaptainwutax.tungsten.path.PathExecutor.mineHits,
                kaptainwutax.tungsten.path.PathExecutor.mineNoProgress,
                adris.altoclef.control.InputControls.attackStealers(),
                adris.altoclef.chains.MobDefenseChain.fireReleaseSkipped,
                kaptainwutax.tungsten.path.PathExecutor.breakOnTarget,
                kaptainwutax.tungsten.path.PathExecutor.breakOffTarget,
                kaptainwutax.tungsten.path.PathExecutor.breakAimedElsewhere,
                kaptainwutax.tungsten.path.PathExecutor.breakAimedAtNothing,
                kaptainwutax.tungsten.path.PathExecutor.breakAbortTimeout,
                kaptainwutax.tungsten.path.PathExecutor.breakAbortReach,
                kaptainwutax.tungsten.path.PathExecutor.breakReachNear,
                kaptainwutax.tungsten.path.PathExecutor.breakReachMid,
                kaptainwutax.tungsten.path.PathExecutor.breakReachFar,
                kaptainwutax.tungsten.path.PathExecutor.lastReachAbort,
                kaptainwutax.tungsten.path.PathExecutor.breakOccluded,
                kaptainwutax.tungsten.path.PathExecutor.breakAimInTransit,
                kaptainwutax.tungsten.path.PathExecutor.breakOccluderInPlan,
                kaptainwutax.tungsten.path.PathExecutor.breakOccluderForeign,
                kaptainwutax.tungsten.path.PathExecutor.breakClearedOccluder,
                kaptainwutax.tungsten.path.PathExecutor.breakOccluderProtected,
                kaptainwutax.tungsten.path.PathExecutor.lastBreakMiss,
                adris.altoclef.tasks.movement.TimeoutWanderTask.wanderTripBlocked,
                kaptainwutax.tungsten.path.PathFinder.emptyPathRefused,
                kaptainwutax.tungsten.path.PathFinder.guideVanished,
                kaptainwutax.tungsten.path.PathFinder.guideVanishedSalvaged,
                kaptainwutax.tungsten.path.PathFinder.searchAborted,
                kaptainwutax.tungsten.path.PathFinder.emitCount,
                kaptainwutax.tungsten.path.PathFinder.emitTotalNodes,
                kaptainwutax.tungsten.path.PathFinder.emitFresh,
                kaptainwutax.tungsten.path.PathFinder.emitAppended,
                kaptainwutax.tungsten.path.PathFinder.tryEmitCalls,
                kaptainwutax.tungsten.path.PathFinder.tryEmitStationary,
                kaptainwutax.tungsten.path.PathFinder.tryEmitMoving,
                ...
                kaptainwutax.tungsten.path.PathFinder.gvpSamples,
                kaptainwutax.tungsten.path.PathFinder.gvpTinyGuide,
                kaptainwutax.tungsten.path.PathFinder.gvpStuckAtStart,
                kaptainwutax.tungsten.path.PathFinder.gvpReachedGuideEnd,
                kaptainwutax.tungsten.path.PathFinder.gvpNoGuide,
                kaptainwutax.tungsten.path.PathFinder.guideFromFast,
                kaptainwutax.tungsten.path.PathFinder.guideFromFastNowhere,
                kaptainwutax.tungsten.path.PathFinder.guideFromCoarse,
                kaptainwutax.tungsten.path.PathFinder.guideFromCoarseNowhere,
                kaptainwutax.tungsten.path.PathFinder.truncCut,
                kaptainwutax.tungsten.path.PathFinder.truncCutToOneNode,
                kaptainwutax.tungsten.path.PathFinder.fastNowhereTruncated,
                kaptainwutax.tungsten.path.PathFinder.fastNowhereOther,
                kaptainwutax.tungsten.path.PathFinder.coarseNowhereDump(),
                kaptainwutax.tungsten.path.PathFinder.gvpHopDump(),
                kaptainwutax.tungsten.path.blockSpaceSearchAssist.BlockNode.fallCheckRun,
                kaptainwutax.tungsten.path.blockSpaceSearchAssist.BlockNode.fallCheckRefused,
                kaptainwutax.tungsten.path.blockSpaceSearchAssist.BlockNode.smartKept,
                kaptainwutax.tungsten.path.blockSpaceSearchAssist.BlockNode.smartDropped,
                kaptainwutax.tungsten.path.PathFinder.resumeLetItFinish,
                kaptainwutax.tungsten.path.PathFinder.stopByDump(),
                kaptainwutax.tungsten.path.PathFinder.stallSpared,
                kaptainwutax.tungsten.path.blockSpaceSearchAssist.BlockSpacePathFinder.bsComplete,
                kaptainwutax.tungsten.path.blockSpaceSearchAssist.BlockSpacePathFinder.bsTimeout,
                kaptainwutax.tungsten.path.blockSpaceSearchAssist.BlockSpacePathFinder.bsStopped,
                kaptainwutax.tungsten.path.blockSpaceSearchAssist.BlockSpacePathFinder.bsExhausted,
                kaptainwutax.tungsten.path.blockSpaceSearchAssist.BlockSpacePathFinder.bsClosestCm,
                kaptainwutax.tungsten.path.blockSpaceSearchAssist.BlockSpacePathFinder.bsFindCalls,
                kaptainwutax.tungsten.path.blockSpaceSearchAssist.BlockSpacePathFinder.bsSearchCalls,
                kaptainwutax.tungsten.path.blockSpaceSearchAssist.BlockSpacePathFinder.bsLoopIters,
                kaptainwutax.tungsten.path.blockSpaceSearchAssist.BlockSpacePathFinder.bsStub,
                kaptainwutax.tungsten.path.blockSpaceSearchAssist.BlockSpacePathFinder.bsStubHadCloser,
                kaptainwutax.tungsten.path.blockSpaceSearchAssist.BlockSpacePathFinder.bsStubCloserCm,
                kaptainwutax.tungsten.path.blockSpaceSearchAssist.BlockSpacePathFinder.bsClosestUsed,
                kaptainwutax.tungsten.path.PathFinder.salvageEmit,
                kaptainwutax.tungsten.path.PathFinder.salvageEmitNodes,
                kaptainwutax.tungsten.path.PathFinder.resetEmit,
                kaptainwutax.tungsten.path.PathFinder.resetEmitNodes,
                kaptainwutax.tungsten.path.PathFinder.resetEmitRefused,
                kaptainwutax.tungsten.path.PathFinder.resetNoGain,
                kaptainwutax.tungsten.path.PathFinder.rawChildren,
                kaptainwutax.tungsten.path.PathFinder.validAfterFilter,
                kaptainwutax.tungsten.path.PathFinder.expandedChildren,
                kaptainwutax.tungsten.path.Node.rejJumpSneak,
                kaptainwutax.tungsten.path.Node.rejAtWaypoint,
                kaptainwutax.tungsten.path.Node.rejSneakAir,
                kaptainwutax.tungsten.path.Node.rejSneakJump,
                kaptainwutax.tungsten.path.Node.paramsOffered,
                kaptainwutax.tungsten.path.Node.createCalls,
                kaptainwutax.tungsten.path.Node.sweepKept,
                kaptainwutax.tungsten.path.Node.sweepNarrowed,
                kaptainwutax.tungsten.path.PathFinder.salvageEmit,
                kaptainwutax.tungsten.path.PathFinder.salvageEmitNodes,
                ...
                kaptainwutax.tungsten.path.Node.fallHarmlessAllowed,
                kaptainwutax.tungsten.path.blockSpaceSearchAssist.BlockNode.blockFallHarmless,
                kaptainwutax.tungsten.path.Node.fallPriced,
                kaptainwutax.tungsten.path.blockSpaceSearchAssist.BlockNode.blockFallPriced,
                kaptainwutax.tungsten.path.PathFinder.gaveUpFallRetry,
                kaptainwutax.tungsten.path.PathFinder.wallSkipRefused,
                kaptainwutax.tungsten.path.PathFinder.wallAlreadyAir,
                kaptainwutax.tungsten.path.PathExecutor.gotoResumedFromSearch,
                ...
                adris.altoclef.util.helpers.TungstenHelper.lockTicks,
                adris.altoclef.util.helpers.TungstenHelper.lockSearching,
                adris.altoclef.util.helpers.TungstenHelper.lockExecuting,
                adris.altoclef.util.helpers.TungstenHelper.lockWalking,
                adris.altoclef.util.helpers.TungstenHelper.lockQueue,
                adris.altoclef.util.helpers.TungstenHelper.lockIdle,
                adris.altoclef.util.helpers.TungstenHelper.lockMoved,
                adris.altoclef.util.helpers.TungstenHelper.lockDroppedIdle,
                adris.altoclef.util.helpers.TungstenHelper.lockRetargetDone,
                adris.altoclef.util.helpers.TungstenHelper.lockRetargetSkipped,
                ...
                adris.altoclef.tasks.entity.AbstractDoToEntityTask.dteItemNearNotHittable,
                ...
                adris.altoclef.tasksystem.TaskRunner.chainTicksDump(),
                adris.altoclef.chains.UnstuckChain.strandedRescues,
                adris.altoclef.chains.UnstuckChain.strandedSkippedDigging,
                adris.altoclef.chains.UnstuckChain.unstuckOwnedTicks,
                adris.altoclef.chains.UnstuckChain.rescueNearPrevious,
                adris.altoclef.chains.UnstuckChain.rescueMovedOn,
                ...
                adris.altoclef.chains.UnstuckChain.unstuckAcrobaticsSuppressed,
                adris.altoclef.tasks.AbstractDoToClosestObjectTask.dcReofferedBanned,
                adris.altoclef.tasks.AbstractDoToClosestObjectTask.dcRefusedBanned,
                adris.altoclef.util.helpers.TungstenHelper.tpNotLoaded,
                adris.altoclef.util.helpers.TungstenHelper.tpFailCount,
                adris.altoclef.util.helpers.TungstenHelper.tpBarren,
                adris.altoclef.util.helpers.TungstenHelper.tpCooldown,
                adris.altoclef.util.helpers.TungstenHelper.tpBarrenBypassed,
                adris.altoclef.tasks.resources.MineAndCollectTask.MineOrCollectTask.minePickFar,
                adris.altoclef.tasks.resources.MineAndCollectTask.MineOrCollectTask.minePickTotal,
                adris.altoclef.tasks.resources.MineAndCollectTask.MineOrCollectTask.minePickFarthest,
                adris.altoclef.tasks.resources.MineAndCollectTask.MineOrCollectTask.minePickCalls,
                adris.altoclef.tasks.resources.MineAndCollectTask.MineOrCollectTask.minePickDrop,
                adris.altoclef.tasks.AbstractDoToClosestObjectTask.dcPursuitFarthest,
                ...
                adris.altoclef.tasks.slot.MoveItemToSlotTask.mvTicks,
                adris.altoclef.tasks.slot.MoveItemToSlotTask.mvBlocked,
                adris.altoclef.tasks.slot.MoveItemToSlotTask.mvPickup,
                adris.altoclef.tasks.slot.MoveItemToSlotTask.mvPlace,
                adris.altoclef.tasks.slot.MoveItemToSlotTask.mvNoSource,
                adris.altoclef.tasks.construction.PlaceBlockNearbyTask.pnbTicks,
    ...
    /** Agent primitive (2026-09-16): run altoclef's OWN DestroyBlockTask on an explicit block --
     *  the miner BeatMinecraftTask uses ("Block in range, mining..."), as opposed to
     *  {@link #mineBlocks}, which is tungsten's route-dig queue. Exists so a stall of THAT miner
     *  (the 00:12 crafting-table stare on the 2026-09-16 recording) can be reproduced from any
     *  position without steering the crosshair, which @mineblock needs and a cramped cave forbids. */
    public Map<String, Object> destroyBlockAt(int x, int y, int z) {
        return onClientThread(() -> {
            Map<String, Object> out = new HashMap<>();
            if (MinecraftClient.getInstance().player == null) { out.put("ok", false); out.put("reason", "not in game"); return out; }
            net.minecraft.util.math.BlockPos pos = new net.minecraft.util.math.BlockPos(x, y, z);
            _mod.runUserTask(new adris.altoclef.tasks.construction.DestroyBlockTask(pos));
            out.put("ok", true); out.put("pos", pos.toShortString());
            return out;
        }, Map.of("ok", false, "reason", "client thread timeout"));
    }
