...
public class Py4jEntryPoint {
    ...
    public java.util.Map<String, Object> resetRunCounters() {
        ...
        kaptainwutax.tungsten.path.fast.FastPlanner.planAtGoalWho = "-";
