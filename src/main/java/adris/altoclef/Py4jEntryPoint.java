    ...
    public String placeStats() {
        ...
        return String.format(
                "called=%d deferred=%d inRange=%d clicked=%d"
                        ...
                        + " entityReleased=%d/%d idrop=%d/%d/%d/%d/%d rt=%d/%d/%d entityCloseWalk=%d/%d/%d/%d/%d/%d/%d",
