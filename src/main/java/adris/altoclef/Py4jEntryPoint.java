    ...
    public String placeStats() {
        ...
        return String.format(
                "called=%d deferred=%d inRange=%d clicked=%d"
                        ...
                        + " mqLost=%d mqStatusFail=%d mqRefused=%d(short=%d vetoed=%d) mqNoClass=%d mqNull=%d gaveUp=%d/%d dc=%d/%d/%d/%d/%d mc=%d/%d/%d/%d/%d mcFlight=%d toolSwap=%d recipesKnown=%d wander=%d wanderMoved=%d navUnsafeAir=%d sm=%d/%d smWater=%d srch=%d/%d/%d drop=%d/%d et=%d/%d"
